...
- [ ] Governor market action: a small monthly sell order for idle energy/trade into alloys or minerals (player action through the market screen; needs a live check that the AI keeps the order)
